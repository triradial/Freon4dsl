...
function peg$parse(input, options) {
  ...
  var peg$e32 = peg$otherExpectation("required whitespace");
  var peg$e33 = peg$otherExpectation("variable");
  ...
  var peg$e52 = peg$classExpectation([["\0", "\x1F"], "\"", "\\"], true, false);
  var peg$e53 = peg$classExpectation([["0", "9"], ["a", "f"]], false, false);
  ...
  var peg$f26 = function(exp2, exp1, extra) {
  ...
  function peg$parseisuniqueRule() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        s3 = peg$parserws();
        if (s3 !== peg$FAILED) {
          s4 = peg$parseisuniqueKey();
          if (s4 !== peg$FAILED) {
            s5 = peg$parselangExpression();
            if (s5 !== peg$FAILED) {
              s6 = peg$parsews();
              s7 = peg$parseruleExtras();
              if (s7 === peg$FAILED) {
                s7 = null;
              }
              peg$savedPos = s0;
