...
function peg$parse(input, options) {
  ...
  var peg$e16 = peg$otherExpectation("required whitespace");
  var peg$e17 = peg$otherExpectation("variable");
  ...
  var peg$e37 = peg$classExpectation([["0", "9"], ["a", "f"]], false, false);
  ...
  var peg$f1 = function(classifierRef, exps) {
  ...
  var peg$f6 = function(exp) {return exp;};
  var peg$f7 = function(name, param, applied) {
  ...
  var peg$f8 = function(name, applied) {
  ...
  var peg$f10 = function(conceptName, instance) {
...
( {
  ...
  var peg$f12 = function(first, rest) { return first + rest.join(""); };
  var peg$f13 = function(chars) { return chars.join(""); };
  var peg$f14 = function(nums) { return nums.join(""); };
  ...
  function peg$parseappliedExpression() {
