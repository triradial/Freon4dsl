...
import pkg from 'net.akehurst.language-agl-processor';
const { SyntaxAnalyserByMethodRegistrationAbstract } = pkg;
import type { KtList, Sentence, SpptDataNodeInfo, SpptDataNode, SPPTBranch } from 'net.akehurst.language-agl-processor';
