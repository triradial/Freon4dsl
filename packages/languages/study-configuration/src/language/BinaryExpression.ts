...
import { observablepart, type FreBinaryExpression, FreParseLocation, notNullOrUndefined } from "@freon4dsl/core";
 ...
 */
export abstract class BinaryExpression extends ScheduleExpression implements FreBinaryExpression {
    ...
    left!: ScheduleExpression; // implementation of part 'left'
    right!: ScheduleExpression; // implementation of part 'right'
     ...
     */
    abstract copy(): BinaryExpression;
