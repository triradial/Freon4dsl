 ...
 */
export class Reference extends MobxModelElementImpl implements FreNamedNode {
    /**
    ...
    static create(data: Partial<Reference>): Reference {
        ...
        if (notNullOrUndefined(data.link)) {
    ...
    copy(): Reference {
        ...
        if (notNullOrUndefined(this.link)) {
    ...
    public match(toBeMatched: Partial<Reference>): boolean {
        ...
        if (result && toBeMatched.link !== null && toBeMatched.link !== undefined && toBeMatched.link.length > 0) {
