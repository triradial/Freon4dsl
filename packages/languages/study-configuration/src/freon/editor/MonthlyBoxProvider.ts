...
import { Monthly } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type Monthly.
...
export class MonthlyBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxUtil.labelBox(this._node as Monthly, "monthly", "top-1-line-0-item-0");
    }
