...
import { String } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type String.
 ...
 */
export class StringBoxProvider extends FreBoxProvider {
        ...
        return createDefaultExpressionBox(
            ...
            [
                BoxFactory.horizontalLayout(
                    ...
                    "",
                    [
                        BoxUtil.labelBox(this._node as String, "\'", "top-1-line-0-item-0"),
                        BoxUtil.textBox(this._node as String, "value"),
                        BoxUtil.labelBox(this._node as String, "\'", "top-1-line-0-item-2"),
                    ],
                    { selectable: false },
                ),
            ],
