...
import { Forever } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type Forever.
...
export class ForeverBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxUtil.labelBox(this._node as Forever, "forever", "top-1-line-0-item-0");
    }
