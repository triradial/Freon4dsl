...
import { Days } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type Days.
...
export class DaysBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxUtil.numberReplacerBox(this._node as Days, "count", "CustomNumericComponent");
    }

    private getParser(): Box {
        return BoxUtil.numberBox(this._node as Days, "count", NumberDisplay.SELECT);
    }
}
