...
import { Unscheduled } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type Unscheduled.
 ...
 */
export class UnscheduledBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default", "parser"];
        this.knownTableProjections = ["default"];
        this.conceptName = "Unscheduled";
    }
    ...
    private getDefault(): Box {
        return BoxUtil.labelBox(this._node as Unscheduled, "on any day (an unscheduled event)", "top-1-line-0-item-0");
    }
