...
import { DateConcept } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type DateConcept.
 ...
 */
export class DateConceptBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default", "parser"];
        this.knownTableProjections = ["default"];
        this.conceptName = "DateConcept";
    }
    ...
    private getDefault(): Box {
        return BoxUtil.stringReplacerBox(this._node as DateConcept, "dateAsString", "DatePickerComponent", {
            params: [{ key: "startDate", value: "30/09/2024" }],
        });
    }

    private getParser(): Box {
        return BoxUtil.textBox(this._node as DateConcept, "dateAsString");
    }
}
