...
import { AnyDay } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type AnyDay.
...
export class AnyDayBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxUtil.labelBox(this._node as AnyDay, "on any day (an unscheduled event)", "top-1-line-0-item-0");
    }
