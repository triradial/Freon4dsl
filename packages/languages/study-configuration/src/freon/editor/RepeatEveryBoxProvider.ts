...
import { RepeatEvery } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type RepeatEvery.
 ...
 */
export class RepeatEveryBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default", "parser"];
        this.knownTableProjections = ["default"];
        this.conceptName = "RepeatEvery";
    }
    ...
    private getDefault(): Box {
        return BoxFactory.horizontalLayout(
            this._node as RepeatEvery,
            "RepeatEvery-hlist-line-0",
            "",
            [
                BoxUtil.labelBox(this._node as RepeatEvery, "repeats every:", "top-1-line-0-item-0"),
                BoxUtil.getBoxOrAction(this._node as RepeatEvery, "repeatEvery", "Time", this.mainHandler),
            ],
            { selectable: false },
        );
    }
    ...
    private getParser(): Box {
        return BoxFactory.horizontalLayout(
            ...
            "",
            [
                BoxUtil.labelBox(this._node as RepeatEvery, "every:", "top-1-line-0-item-0"),
                BoxUtil.getBoxOrAction(this._node as RepeatEvery, "repeatEvery", "Time", this.mainHandler),
            ],
            { selectable: false },
        );
