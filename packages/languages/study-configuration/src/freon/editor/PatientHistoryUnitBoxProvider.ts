...
import { PatientHistoryUnit } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type PatientHistoryUnit.
 ...
 */
export class PatientHistoryUnitBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default", "parser"];
        this.knownTableProjections = ["default"];
        this.conceptName = "PatientHistoryUnit";
    }
    ...
    private getDefault(): Box {
        return BoxUtil.getBoxOrAction(this._node as PatientHistoryUnit, "patientHistory", "PatientHistory", this.mainHandler);
    }
