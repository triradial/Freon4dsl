...
import { Description, Event } from "./internal.js";

// TEMPLATE: ConceptTemplate.generateConceptPrivate
import { makeObservable, action } from "mobx";

/**
 * Class Period is the implementation of the concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to the changes in the state of its properties.
 */
export class Period extends MobxModelElementImpl implements FreNamedNode {
    /**
     * A convenience method that creates an instance of this class
     * based on the properties defined in 'data'.
     * @param data partial object
     */
    static create(data: Partial<Period>): Period {
        const result = new Period(data.$id);
        ...
        if (notNullOrUndefined(data.events)) {
            data.events.forEach((x) => result.events.push(x));
        }
    ...
    readonly $typename: string = "Period"; // holds the metatype in the form of a string
    ...
    events!: Event[]; // implementation of part 'events'
    ...
    constructor(id?: string) {
        ...
        observablepartlist(this, "events");
    ...
    copy(): Period {
        ...
        if (notNullOrUndefined(this.events)) {
            this.events.forEach((x) => result.events.push(x.copy()));
        }
        return result;
    }
    /**
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<Period>): boolean {
        ...
        if (result && notNullOrUndefined(toBeMatched.events)) {
            result = result && matchElementList(this.events, toBeMatched.events);
        }
        return result;
    }
}
