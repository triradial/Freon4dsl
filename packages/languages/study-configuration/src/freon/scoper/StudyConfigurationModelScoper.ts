...
/**
 * Class StudyConfigurationModelScoper implements the scoper generated from, if present, the scoper definition,
 * otherwise this class implements the default scoper.
 */
export class StudyConfigurationModelScoper extends FreScoperBase {
    /**
