...
export class StudyConfigurationModelTyperPart implements FreTyper {
    mainTyper!: FreCompositeTyper; //  Setting this property to an instance of StudyConfigurationModelTyper is ensured by 'initializeTypers()'
