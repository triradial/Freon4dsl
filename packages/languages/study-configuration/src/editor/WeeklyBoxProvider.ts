...
import { Weekly } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type Weekly.
...
export class WeeklyBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxUtil.labelBox(this._node as Weekly, "weekly", "top-1-line-0-item-0");
    }
