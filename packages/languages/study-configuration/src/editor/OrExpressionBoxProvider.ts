...
import { OrExpression } from "../language/index.js";
...
export class OrExpressionBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return createDefaultBinaryBox(this._node as FreBinaryExpression, "or", LanguageEnvironment.getInstance().editor, this.mainHandler);
    }
