...
import { Day } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type Day.
...
export class DayBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxFactory.horizontalLayout(
            ...
            "",
            [
                BoxUtil.labelBox(this._node as Day, "day", "top-1-line-0-item-0"),
                BoxUtil.numberReplacerBox(this._node as Day, "startDay", "CustomNumericComponent", {
                    params: [
                        { key: "min", value: "0" },
                        { key: "max", value: "999" },
                    ],
    ...
    private getParser(): Box {
        return BoxFactory.horizontalLayout(
            ...
            [
                BoxUtil.labelBox(this._node as Day, "day", "top-1-line-0-item-0"),
                BoxUtil.numberBox(this._node as Day, "startDay", NumberDisplay.SELECT),
            ],
            { selectable: false },
        );
    }
