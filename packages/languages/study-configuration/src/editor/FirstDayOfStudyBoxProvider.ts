...
import { FirstDayOfStudy } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type FirstDayOfStudy.
 ...
 */
export class FirstDayOfStudyBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default", "parser"];
        this.knownTableProjections = ["default"];
        this.conceptName = "FirstDayOfStudy";
    }
    ...
    private getDefault(): Box {
        return BoxFactory.horizontalLayout(
            this._node as FirstDayOfStudy,
            "FirstDayOfStudy-hlist-line-0",
            "",
            [
                BoxUtil.labelBox(this._node as FirstDayOfStudy, "on the start day of the study", "top-1-line-0-item-0"),
                BoxUtil.getBoxOrAction(this._node as FirstDayOfStudy, "timeAmountPart", "TimeAmountPart", this.mainHandler),
            ],
            { selectable: false },
        );
    }
