...
import { AndExpression } from "../language/index.js";
...
export class AndExpressionBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return createDefaultBinaryBox(this._node as FreBinaryExpression, "and", LanguageEnvironment.getInstance().editor, this.mainHandler);
    }
