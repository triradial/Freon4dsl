...
import { StartingBy } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type StartingBy.
 ...
 */
export class StartingByBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default", "parser"];
        this.knownTableProjections = ["default"];
        this.conceptName = "StartingBy";
    }
    ...
    private getDefault(): Box {
        return BoxFactory.horizontalLayout(
            this._node as StartingBy,
            "StartingBy-hlist-line-0",
            "",
            [
                BoxUtil.labelBox(this._node as StartingBy, "starting by", "top-1-line-0-item-0"),
                BoxUtil.stringReplacerBox(this._node as StartingBy, "startTimeAsString", "CustomTimePickerComponent"),
            ],
            { selectable: false },
        );
    }
    ...
    private getParser(): Box {
        return BoxFactory.horizontalLayout(
            ...
            [
                BoxUtil.labelBox(this._node as StartingBy, "starting by", "top-1-line-0-item-0"),
                BoxUtil.stringReplacerBox(this._node as StartingBy, "startTimeAsString", "TimePickerComponent"),
            ],
            { selectable: false },
        );
    }
