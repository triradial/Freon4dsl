...
import { EventReferenceExpression, Event, EventState } from "../language/index.js";

import { LanguageEnvironment } from "../index.js";

/**
 * This class implements the box provider for a single node of type EventReferenceExpression.
 ...
 */
export class EventReferenceExpressionBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "EventReferenceExpression";
    }
    ...
    private getDefault(): Box {
        return createDefaultExpressionBox(
            this._node as EventReferenceExpression,
            [
                BoxFactory.horizontalLayout(
                    this._node as EventReferenceExpression,
                    "EventReferenceExpression-hlist-line-0",
                    "",
                    [
                        BoxUtil.referenceBox(
                            ...
                            (selected: string | FreNamedNode) => {
                                ...
                                (this._node as EventReferenceExpression).event = ref;
                            },
                        ...
                        BoxUtil.limitedBox(
                            ...
                            (selected: string | EventState) => {
                                (this._node as EventReferenceExpression).eventState = FreNodeReference.create<EventState>(
                                    selected,
                                    "EventState",
                                );
                            },
