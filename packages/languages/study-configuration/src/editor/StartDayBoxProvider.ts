...
import { StartDay } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type StartDay.
 ...
 */
export class StartDayBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "StartDay";
    }
    ...
    private getDefault(): Box {
        return createDefaultExpressionBox(
            this._node as StartDay,
            [BoxUtil.labelBox(this._node as StartDay, "start day", "top-1-line-0-item-0")],
            { selectable: false },
        );
    }
}
