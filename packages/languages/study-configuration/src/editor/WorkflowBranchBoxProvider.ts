...
import { WorkflowBranch } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type WorkflowBranch.
 ...
 */
export class WorkflowBranchBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default", "parser"];
        this.knownTableProjections = ["default"];
        this.conceptName = "WorkflowBranch";
    }
    ...
    private getDefault(): Box {
        return BoxFactory.horizontalLayout(
            this._node as WorkflowBranch,
            "WorkflowBranch-hlist-line-0",
            "",
            [
                BoxUtil.labelBox(this._node as WorkflowBranch, "Branch:", "top-1-line-0-item-0"),
                BoxUtil.getBoxOrAction(this._node as WorkflowBranch, "branch", "ScheduleExpression", this.mainHandler),
            ],
            { selectable: false },
        );
    }
