...
import { Baseline } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type Baseline.
...
export class BaselineBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxFactory.horizontalLayout(
            this._node as Baseline,
            "Baseline-hlist-line-0",
            "",
            [
                BoxUtil.labelBox(this._node as Baseline, "on the baseline\/start day of the study", "top-1-line-0-item-0"),
                BoxUtil.getBoxOrAction(this._node as Baseline, "timeAmountPart", "TimeAmountPart", this.mainHandler),
            ],
            { selectable: false },
        );
    }
