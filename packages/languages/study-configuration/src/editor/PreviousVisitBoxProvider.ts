...
import { PreviousVisit } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type PreviousVisit.
 ...
 */
export class PreviousVisitBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "PreviousVisit";
    }
    ...
    private getDefault(): Box {
        return createDefaultExpressionBox(
            this._node as PreviousVisit,
            [BoxUtil.labelBox(this._node as PreviousVisit, "previous visit", "top-1-line-0-item-0")],
            { selectable: false },
        );
    }
}
