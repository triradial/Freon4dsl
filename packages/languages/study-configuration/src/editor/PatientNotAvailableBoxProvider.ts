...
import { Box, BoxUtil, FreBoxProvider, FreProjectionHandler, FreListInfo } from "@freon4dsl/core";
import { PatientNotAvailable } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type PatientNotAvailable.
 ...
 */
export class PatientNotAvailableBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default", "parser"];
        this.knownTableProjections = ["default"];
        this.conceptName = "PatientNotAvailable";
    }
    ...
    private getDefault(): Box {
        return BoxUtil.verticalPartListBox(
            this._node as PatientNotAvailable,
            (this._node as PatientNotAvailable).dates,
            "dates",
