...
import { WorkflowDescription } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type WorkflowDescription.
 ...
 */
export class WorkflowDescriptionBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default", "parser"];
        this.knownTableProjections = ["default"];
        this.conceptName = "WorkflowDescription";
    }
    ...
    private getDefault(): Box {
        return BoxFactory.horizontalLayout(
            this._node as WorkflowDescription,
            "WorkflowDescription-hlist-line-0",
            "",
            [
                BoxUtil.labelBox(this._node as WorkflowDescription, "Description:", "top-1-line-0-item-0"),
                BoxUtil.getBoxOrAction(this._node as WorkflowDescription, "text", "Description", this.mainHandler),
            ],
            { selectable: false },
        );
    }
