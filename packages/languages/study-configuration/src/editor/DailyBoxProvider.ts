...
import { Daily } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type Daily.
...
export class DailyBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxUtil.labelBox(this._node as Daily, "daily", "top-1-line-0-item-0");
    }
