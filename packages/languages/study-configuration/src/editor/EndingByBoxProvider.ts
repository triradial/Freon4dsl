...
import { EndingBy } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type EndingBy.
...
export class EndingByBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxFactory.horizontalLayout(
            this._node as EndingBy,
            "EndingBy-hlist-line-0",
            "",
            [
                BoxUtil.labelBox(this._node as EndingBy, "ending by", "top-1-line-0-item-0"),
                BoxUtil.stringReplacerBox(this._node as EndingBy, "endTimeAsString", "CustomTimePickerComponent"),
            ],
            { selectable: false },
        );
    }
    ...
    private getParser(): Box {
        return BoxFactory.horizontalLayout(
            ...
            [
                BoxUtil.labelBox(this._node as EndingBy, "ending by", "top-1-line-0-item-0"),
                BoxUtil.stringReplacerBox(this._node as EndingBy, "endTimeAsString", "TimePickerComponent"),
            ],
            { selectable: false },
        );
    }
