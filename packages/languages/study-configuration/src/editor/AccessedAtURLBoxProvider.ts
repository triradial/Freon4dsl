...
import { AccessedAtURL } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type AccessedAtURL.
 ...
 */
export class AccessedAtURLBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default", "parser"];
        this.knownTableProjections = ["default"];
        this.conceptName = "AccessedAtURL";
    }
    ...
    private getDefault(): Box {
        return BoxUtil.stringReplacerBox(this._node as AccessedAtURL, "url", "UrlInputComponent");
    }

    private getParser(): Box {
        return BoxFactory.horizontalLayout(
            this._node as AccessedAtURL,
            "AccessedAtURL-hlist-line-0",
            "",
            [
                BoxUtil.labelBox(this._node as AccessedAtURL, "URL:", "top-1-line-0-item-0"),
                BoxUtil.textBox(this._node as AccessedAtURL, "url"),
            ],
            { selectable: false },
        );
    }
