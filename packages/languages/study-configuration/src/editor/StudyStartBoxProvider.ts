...
import { StudyStart } from "../language/index.js";

/**
 * This class implements the box provider for a single node of type StudyStart.
 ...
 */
export class StudyStartBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default", "parser"];
        this.knownTableProjections = ["default"];
        this.conceptName = "StudyStart";
    }
    ...
    private getDefault(): Box {
        return BoxUtil.labelBox(this._node as StudyStart, "as the start day of the study", "top-1-line-0-item-0");
    }

    private getParser(): Box {
        return BoxFactory.horizontalLayout(
            this._node as StudyStart,
            "StudyStart-hlist-line-0",
            "",
            [
                BoxUtil.textBox(this._node as StudyStart, "dummyText"),
                BoxUtil.labelBox(this._node as StudyStart, "as the start day of the study", "top-1-line-0-item-1"),
            ],
            { selectable: false },
        );
    }
