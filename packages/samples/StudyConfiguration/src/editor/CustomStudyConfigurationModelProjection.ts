        ...
        BoxFactory.verticalLayout(element, "EventSchedule-overall", "", 
          [
            BoxFactory.horizontalLayout(element, "schedule-event-start-group", "",
              [
                BoxUtil.labelBox(element, "First Scheduled:", "schedule-event-start-label", { cssClass: "app-small-caps" }),
            ...
            BoxFactory.horizontalLayout(element, "EventSchedule-hlist-line-1", "",
              [
                BoxUtil.labelBox(element, "Then Repeats:", "schedule-then", { cssClass: "app-small-caps" }),
            ...
            BoxFactory.horizontalLayout(element, "EventSchedule-hlist-line-2", "",
              [
                BoxUtil.labelBox(element, "Window:", "schedule-window", { cssClass: "app-small-caps" }),
            ...
            BoxFactory.horizontalLayout(element, "EventSchedule-hlist-line-3", "",
              [
                BoxUtil.labelBox(element, "Time of Day:", "top-1-line-3-item-0", { cssClass: "app-small-caps" }),
      ...
      switch (element.type) {
            ...
            BoxUtil.indentBox(element, 4, "it1",
              BoxFactory.verticalLayout(element, "task-overall", "", [
                ...
                BoxUtil.listGroupBox(element, "steps", "Steps",
                  BoxUtil.indentBox(element, 3, "e12",
        ...
        case "R": // REFERENCE
          ...
          box = BoxUtil.itemGroupBox(refTask, "task", "Task:", "name",
            BoxUtil.indentBox(refTask, 4, "it1",
              BoxFactory.verticalLayout(refTask, "task-overall", "", [
                ...
                BoxUtil.listGroupBox(refTask, "steps", "Steps",
                  BoxUtil.indentBox(refTask, 3, "e12",
