...
/**
 * Class CustomConformanceRulesModelActions provides an entry point for the language engineer to
 ...
 */
export class CustomConformanceRulesModelActions implements FreCombinedActions {
