...
import { ConformanceRulesModelInterpreterInit } from "./gen/ConformanceRulesModelInterpreterInit.js";
 ...
 */
export class MainConformanceRulesModelInterpreter implements FreInterpreter {
    private static main: IMainInterpreter = null;

    constructor() {
        if (MainConformanceRulesModelInterpreter.main === null) {
            MainConformanceRulesModelInterpreter.main = MainInterpreter.instance(
                ConformanceRulesModelInterpreterInit,
                getConceptFunction,
                getPropertyFunction,
            );
        }
    ...
    setTracing(value: boolean) {
        MainConformanceRulesModelInterpreter.main.setTracing(value);
    }

    getTrace(): InterpreterTracer {
        return MainConformanceRulesModelInterpreter.main.getTrace();
    }
    ...
    evaluateWithContext(node: Object, ctx: InterpreterContext): RtObject {
        MainConformanceRulesModelInterpreter.main.reset();
        try {
            return MainConformanceRulesModelInterpreter.main.evaluate(node, ctx);
        } catch (e: any) {
