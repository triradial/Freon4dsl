...
/**
 * Class 'CustomConformanceRulesModelTyperPart' is meant to be a convient place to add any
 * custom code for type checking.
 */
export class CustomConformanceRulesModelTyperPart implements FreTyper {
    mainTyper: FreTyper;
