...
/**
 * Class CustomScopingExampleActions provides an entry point for the language engineer to
 ...
 */
export class CustomScopingExampleActions implements FreCombinedActions {
