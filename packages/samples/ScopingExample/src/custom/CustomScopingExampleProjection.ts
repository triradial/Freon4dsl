...
/**
 * Class CustomScopingExampleProjection provides an entry point for the language engineer to
 ...
 */
export class CustomScopingExampleProjection implements FreProjection {
    name: string = "Custom";
