<script lang="ts">
    ...
    import { FreEditor, FreNamedNode, FreUtils, PartWrapperBox } from "@freon4dsl/core";
    ...
    $: {
        ...
        if (box?.children && Array.isArray(box.children)) {
            ...
            msg +=
                ...
                "<br>   ";
            const eventScheduleBox = verticalBox.children[0];
            msg += "<br>  Second Box children:" + eventScheduleBox.kind + " concept: " + eventScheduleBox.node.freLanguageConcept() + " Children: <br>   ";
            eventScheduleBox.children.forEach((childBox) => {
