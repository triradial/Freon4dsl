...
<script lang="ts">
    ...
    // Convert placeholder to readable text using camelCase conversion
    if (notNullOrUndefined(box) && placeholder !== '<..>') {
        placeholder = myHelper.camelCaseToReadable(placeholder);
    }
