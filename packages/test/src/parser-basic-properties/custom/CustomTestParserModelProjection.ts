...
/**
 * Class CustomTestParserModelProjection provides an entry point for the language engineer to
 ...
 */
export class CustomTestParserModelProjection implements FreProjection {
    name: string = "Custom";
